...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"MainTread\": () => (/* binding */ MainTread)\n/* harmony export */ });\n/* harmony import */ var _Simulator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Simulator */ \"./src/api/Simulator.ts\");\nvar __extends = (undefined && undefined.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        if (typeof b !== \"function\" && b !== null)\n            throw new TypeError(\"Class extends value \" + String(b) + \" is not a constructor or null\");\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\n\nvar MainTread = /** @class */ (function (_super) {\n    __extends(MainTread, _super);\n    function MainTread(setting, map) {\n        var _this = _super.call(this, setting, map) || this;\n        _this.$thread = navigator.hardwareConcurrency ? navigator.hardwareConcurrency : 1;\n        return _this;\n    }\n    MainTread.prototype.$balancing = function (list) {\n        var cnt = this.$thread;\n        var divLng = Math.floor(list.length / cnt);\n        var am = list.length % cnt;\n        var arr = [];\n        var idx = 0;\n        for (var i = 0; i < this.$thread; i++) {\n            var num = divLng;\n            if (i < am)\n                num++;\n            arr.push(list.slice(idx, idx + num));\n            idx += num;\n        }\n        return arr.filter(function (item) { return item.length; });\n    };\n    return MainTread;\n}(_Simulator__WEBPACK_IMPORTED_MODULE_0__.Simulator));\n\n\n\n//# sourceURL=webpack://world-431/./src/api/worker/Main.ts?");
